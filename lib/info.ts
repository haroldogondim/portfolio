import idhabbo from "@/public/images/idhabbo-v7.png";
import habbozV1 from "@/public/images/habboz-v1.png";
import habbozV2 from "@/public/images/habboz-v2.png";
import tropihabbo from "@/public/images/tropihabbo-v1.png";
import prohabbo from "@/public/images/prohabbo.png";
import forum from "@/public/images/minecraftmedieval.png";
import cpn from "@/public/images/cpn.png";
...
export const experiences = [
  ...
  {
    title: ".add",
    location: { address: "Rio de Janeiro, RJ - Brazil", type: "Remote" },
    position: "Back-end Engineer",
    description: `
      At .add, I worked as a consultant and back-end developer for BrasilCap, a capitalized insurance company under Banco do Brasil. My role primarily focused on developing and maintaining banking services using technologies such as Node.js, MySQL, and AWS services, including Lambda, EC2, S3, CloudWatch, and API Gateway.

      I was responsible for creating REST APIs based on AWS architecture, utilizing Lambda Functions and API Gateway to ensure security, performance, and scalability. I followed best development practices to build robust and scalable systems, enabling the company to handle high-demand services effectively.
      
      Additionally, I contributed to sustaining sprints, where I focused on resolving bugs and addressing complex issues to ensure the continuous availability of services at scale. My work also involved optimizing system performance to maintain efficiency and reduce operational costs.

      I actively participated in agile processes, working within Scrum methodologies. I used tools like Asana to manage tasks and sprints, and I was involved in daily standups, planning, and review meetings, ensuring smooth communication and progress throughout the project lifecycle.`,
  ...
  },
  {
    ...
    description: `
      At Callflex, I worked primarily in system maintenance and support, addressing critical bugs (from levels 1 to 3) and providing quick solutions to everyday issues. My role involved ensuring the reliability of existing systems and occasionally contributing to the development of new features to enhance the company’s offerings in telecom services, such as URAs, chatbots, and omnichannel solutions.

      I utilized technologies such as PHP, HTML, CSS, JavaScript, jQuery, Bootstrap, MySQL, and Git to develop and maintain various systems. A significant portion of my work focused on improving legacy systems, where I applied pure PHP for back-end adjustments and updates. Additionally, I developed and maintained REST APIs based on a microservices architecture, ensuring seamless integration across different services.

     In addition to back-end work, I also contributed to the front-end by implementing improvements to legacy interfaces using HTML, CSS, and JavaScript with jQuery. I worked in a Git environment, following GitFlow for effective code versioning and maintaining code integrity.`,
  ...
  {
    title: "KSRP",
    location: { address: "Brazil", type: "Remote" },
  ...
  {
    title: "VirtusHost",
    location: { address: "Canoas, RS - Brazil", type: "Remote" },
    position: "Full-stack Developer",
    description: `
      As a Full Stack Developer at VirtusHost, I was involved in the development of new pages, systems, and features for the company’s website and services. Using PHP, HTML, CSS, JavaScript, jQuery, Bootstrap, Git, and REST APIs, I worked on various improvements to enhance the platform's functionality.

      One of my key contributions was integrating the Stripe payment API, providing users with a secure and seamless payment experience. Additionally, I worked on integrating an exchange rate conversion API, allowing the website to convert product and service prices between BRL, USD, and EUR.

      I also developed a website internationalization tool that supported multiple languages, including Portuguese, English, and Spanish, to aid in the company's efforts to globalize its services. Furthermore, I made significant improvements to the main website and sales panel, focusing on layout adjustments and responsiveness corrections to improve the overall shopping and browsing experience for users.`,
  ...
  {
    title: "Zaite Tecnologia",
    location: { address: "Recife, PE - Brazil", type: "On-site" },
...
export const projects = [
  {
    title: "Copa Nobru",
    description: `CPN (Copa Nobru) is an amateur and independent Free Fire tournament created by Bruno Goes, also known as Nobru, one of the top Free Fire players in Brazil. As Nobru's popularity continued to soar, he decided to launch his own tournament, and I was invited to design and develop the official website for the event. The website served as the central hub for all tournament-related information, including schedules, player details, and updates.<br><br>
  ...
  {
    title: "KSRP",
    description: `KSRP was a prominent GTA V Roleplay server, built on the FiveM modification platform, using Lua as the primary programming language to simulate real-world environments within the GTA V graphics engine. Between 2019 and 2020, KSRP became the top GTA RP server in Brazil, with over 1,000 active players weekly. The project featured an innovative user interface and numerous exclusive scripts that enhanced the realism of the gameplay, including a modern item inventory system.<br><br>
      In this project, I was not only the creator and visionary but also served as the project manager, leading a dedicated team of over 10 staff members across various roles. I took on the role of the primary software developer, responsible for building and implementing all the features programmatically, including custom scripts and game mechanics.<br><br>
      The project allowed me to further develop my skills in Lua, as well as broaden my knowledge in Node.js, TypeScript, and front-end technologies (HTML, CSS, JavaScript, Bootstrap, and jQuery). I leveraged these skills to design and create dynamic, user-friendly interfaces that contributed to the overall success of the server. KSRP remains one of my most significant personal projects, driven by a passionate community and a dedicated team, and a great achievement in the world of GTA RP.`,
    skills: [
      "Lua",
      "Node.js",
